...
def get_flights(iata: str) -> Dict[str, Any]:
    ...
    try:
        ...
        flight_score = min(len(useful_flights), 150) / 150 * 60  # up to 60 points for up to 150 flights
        airline_score = min(len(unique_airlines), 8) / 8 * 40  # up to 40 points for up to 8 airlines
